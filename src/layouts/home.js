...
const DIA_CHI = 0, DICH_VU = 1, HO_TEN = 2, SDT = 3, EMAIL = 4, NGAY = 5, TIME = 6;
...
class Home extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            txtsdt: '',
            txtEmai: '',
            txtTime: new Date().toLocaleTimeString(),
    ...
    _onSubmitClick() {
        ...
        var input =
            {
                "services": this.state.txtDichVu,
                "cellphone": this.state.txtsdt,
                "user": this.state.txtHoTen,
                "email": this.state.txtEmai,
                "address": this.state.txtEmai,
                "booking_date": `${valueDate} ${this.state.txtTime}`
            }
